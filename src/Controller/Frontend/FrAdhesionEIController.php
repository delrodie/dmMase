...
/**
 * @Route("/adhesion/entreprises-intervenantes")
 */
class FrAdhesionEIController extends AbstractController
{
    ...
    /**
     * @Route("/", name="frontend_adhesion_ei_formulaire", methods={"GET","POST"})
     */
    public function index(Request $request): Response
    {
	    ...
	    if ($form->isSubmitted() && $form->isValid()) {
		    ...
		    if ($mediaFile){
			    ...
			    return $this->redirectToRoute('frontend_adhesion_ei_formulaire');
		    }
		    ...
		    $entreprise->setType('EI');
		
		    $entityManager->persist($entreprise);
		    $entityManager->flush();
		
		    return $this->redirectToRoute('frontend_adhesion_ei_telechargement',[
			    'slug' => $entreprise->getSlug()
		    ]);
	    }
		
        return $this->render('fr_adhesion_ei/index.html.twig', [
	...
	/**
	 * @Route("/{slug}", name="frontend_adhesion_ei_telechargement", methods={"GET"})
	 */
	public function telechargement(Entreprise $entreprise)
	{
		return $this->render('fr_adhesion_ei/telechargement.html.twig',[
			'agendas' => $this->agendaRepository->getEncours(),
